...
## 아파트 감시 지역
`bot.py`의 `REGIONS` 리스트가 원본 (여기 목록은 요약).

- **텔레그램 알림 + 검색**: 하남 망월동 / 용인 상현동 / 인천 연수동·송도동
- **검색 전용** (`telegram: False`): 의왕 내손동 / 서울 강동구 고덕동·명일동·상일동 / 하남 신장동·창우동·덕풍동·풍산동·감일동·감이동·학암동·선동 / 시흥 정왕동

시군구코드(lawd): 하남 41450, 용인수지 41465, 인천연수 28185, 의왕 41430, 서울강동 11740, 시흥 41390
